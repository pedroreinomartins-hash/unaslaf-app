...
DOCS.push({ id:'APOSENTADORIA', title:'REGRAS APOSENTADORIA E PENSOES', category:'APOSENTADORIA E PENSOES', content:` Dependentes de servidores que faleceram na ativa antes da Reforma da Previdência (EC 103/2019) têm direito ao benefício regido pela lei da data do óbito. O valor da pensão depende da regra do ente federativo (União, estado ou município) e se o servidor ingressou no serviço público antes de 31/12/2003.As diretrizes principais são estruturadas da seguinte forma:1. Direito à Integralidade e ParidadePara servidores que ingressaram no serviço público até 31/12/2003, o benefício de pensão por morte pode garantir direitos específicos de acordo com a data do falecimento:Falecimento ocorrido ANTES de 19/12/2003 (EC 41/2003): O benefício era integral, correspondendo a 100% da remuneração do servidor em atividade, inclusive com direito à paridade (reajustes sempre que os salários dos ativos aumentassem).Falecimento ocorrido APÓS 19/12/2003 (EC 41/2003): A integralidade foi extinta para novas pensões. O cálculo passou a ser de 100% do valor do teto do Regime Geral (INSS), mais 70% do que excedesse esse teto.Direito Adquirido (Falecimentos posteriores): O Supremo Tribunal Federal (STF - Tema 396) garante a paridade aos pensionistas caso o servidor já tivesse preenchido todos os requisitos para se aposentar com paridade antes do óbito.2. Regra de Cálculo Atual (União e entes reformados)Se o falecimento do servidor ocorreu após a Reforma da Previdência (13 de novembro de 2019), a Emenda Constitucional 103/2019 estabeleceu novas diretrizes para o cálculo do benefício:O valor base passa a ser a aposentadoria por incapacidade permanente a que o servidor teria direito.O benefício é composto por uma cota familiar de 50% mais 10% por dependente, até atingir o limite de 100%.Exceção de 100%: O valor será integral (100%) se houver dependente inválido ou com deficiência intelectual, mental ou grave.Em entes que não realizaram a Reforma da Previdência própria, as regras antigas (como o teto do INSS + 70% do valor excedente) ainda podem ser aplicadas.3. Quem tem direito a receber?A lei divide os dependentes em ordem de preferência:Classe 1: Cônjuge, companheiro(a) em união estável e filhos menores de 21 anos ou inválidos/deficientes de qualquer idade.Classe 2: Pais (exigem comprovação de dependência econômica e ausência de dependentes da Classe 1).Classe 3: Irmãos (exigem comprovação de dependência econômica, idade até 21 anos ou invalidez, e ausência de dependentes das classes 1 e 2).4. Duração do BenefícioPara o cônjuge ou companheiro, a duração do pagamento da pensão pode variar entre 3 anos e ser vitalícia, dependendo da idade do dependente na data do óbito do servidor, conforme a Lei 13.135/2015. A pensão é vitalícia apenas para quem tem 45 anos ou mais no momento do falecimento do servidor
` });
